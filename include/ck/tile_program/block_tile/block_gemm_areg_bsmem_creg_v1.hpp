                                    ...
                                    const BBlockWindowTmp& b_block_window_tmp)
{
    ...
    constexpr auto a_block_dstr_encode = embed_tile_distribution_encoding(
        a_block_outer_dstr_encoding, typename WG::AWarpDstrEncoding{});

    constexpr auto b_block_dstr_encode = embed_tile_distribution_encoding(
        b_block_outer_dstr_encoding, typename WG::BWarpDstrEncoding{});

    constexpr auto c_block_dstr_encode = embed_tile_distribution_encoding(
...
// A is block distributed tensor
// B is block window on shared memory
// return C block distributed tensor
template <typename ABlockTensorTmp, typename BBlockWindowTmp>
__device__ auto block_gemm_cr_ar_bs(const ABlockTensorTmp& a_block_tensor_tmp,
                                    const BBlockWindowTmp& b_block_window_tmp)
{
    using namespace ck::tile_program::warp;
...
template <typename CBlockTensor, typename ABlockTensorTmp, typename BBlockWindowTmp>
__host__ void block_gemm_cr_ar_bs(CBlockTensor&, const ABlockTensorTmp&, const BBlockWindowTmp&)
{
}

// FIXME: remove: dummy host function for tile programming
template <typename ABlockTensorTmp, typename BBlockWindowTmp>
__host__ auto block_gemm_cr_ar_bs(const ABlockTensorTmp&, const BBlockWindowTmp&)
{
    using namespace ck::tile_program::warp;
