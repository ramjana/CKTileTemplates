...
struct WarpGemmImpl
{
    ...
    static constexpr index_t M = WarpGemmAttribute::Impl::M;
    static constexpr index_t N = WarpGemmAttribute::Impl::N;
    static constexpr index_t K = WarpGemmAttribute::Impl::K;
