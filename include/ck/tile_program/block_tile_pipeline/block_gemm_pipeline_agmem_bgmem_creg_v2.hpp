...
struct BlockGemmPipelineAGmemBGmemCRegV2
{
    ...
    __host__ __device__ auto WarmUp(const ADramBlockWindowTmp& a_dram_block_window_tmp,
                                    const BDramBlockWindowTmp& b_dram_block_window_tmp) const
    {
        static_assert(
                                        ...
                                        void* p_smem) const
    {
        ...
        auto a_block_tile = ab_block_tiles.template At<0>();
        auto b_block_tile = ab_block_tiles.template At<1>();
        ...
        do
        {
            ...
            Policy::template ScheduleReductionLoop<Problem>();
        } while(iCounter > 0);
    ...
    template <typename ADramBlockWindowTmp, typename BDramBlockWindowTmp, typename ABBlockTiles>
