...
struct FmhaFwdKernel
{
    ...
    struct Kargs
    {
        // common attributes for batch & group modes
              ...
              std::optional<std::tuple<const void*, ck::index_t, ck::index_t>> bias = std::nullopt)
    {
        ...
        // initialize group mode attributes
